...
\format{
  ...
  \describe{
    \item{\code{group}}{a factor with two levels \code{KON} \code{TREAT}, where KON is the control group consisting of 19 subjects and TREAT is the treatment group consisting of only 15 subjects due to mortality }
    \item{\code{ASAT}}{a numeric vector containing values of the response variable}
  }
}
